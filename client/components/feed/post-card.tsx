          ...
          <div className="flex items-start space-x-3">
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="flex items-center space-x-2 mt-1">
                ...
                <span className="text-black font-bold text-sm bg-yellow-300 px-2 py-1 border-2 border-black shadow-[2px_2px_0px_0px_#000] transform -rotate-1">
                  {timestamp}
                </span>
              </div>
            </div>
                    ...
                    {mediaItem.type === "image" ? (
                      ...
                      <div className="relative w-full h-64 bg-black border-4 border-black shadow-[6px_6px_0_0_#000]">
                        <video
                          ...
                          onLoadedMetadata={() =>
                            console.log("Video metadata loaded:", mediaItem.url)
                          }
                          onError={(e) =>
                            console.error(
                          ...
                          onLoadStart={() =>
                            console.log("Video load started:", mediaItem.url)
                          }
                          onPlay={() =>
                ...
                <div className="absolute bottom-3 left-1/2 -translate-x-1/2 flex space-x-2">
                  {displayMedia.map((_, index) => (
                    <button
                      ...
                      className={`w-3 h-3 border-2 border-white shadow-[2px_2px_0_0_#000] transition-all transform hover:scale-110 ${
          ...
          <div className="flex items-center justify-between pt-4 border-t-4 border-black bg-white p-3 -mx-6 -mb-6">
            ...
            >
              ...
              <span className="text-sm font-extrabold">
                {initialComments > 0 ? formatNumber(initialComments) : "0"}
              </span>
            </Button>
            ...
            <Button
              variant="ghost"
              size="sm"
              className={`flex items-center space-x-2 p-3 h-auto font-extrabold border-4 border-black shadow-[4px_4px_0px_0px_#000] hover:shadow-[6px_6px_0px_0px_#000] transform hover:-translate-x-1 hover:-translate-y-1 transition-all ${
                isRetweeted
            ...
            >
              ...
              <span className="text-sm font-extrabold">
                {retweets > 0 ? formatNumber(retweets) : "0"}
              </span>
            </Button>
            ...
            <div className="flex items-center space-x-2">
              <Button
                variant="ghost"
                size="sm"
                className={`p-3 h-auto font-extrabold border-4 border-black shadow-[4px_4px_0px_0px_#000] hover:shadow-[6px_6px_0px_0px_#000] transform hover:-translate-x-1 hover:-translate-y-1 transition-all ${
                  isBookmarked

...
export function RightSidebar({
    ...
    return (
        <div className={`w-80 h-screen sticky top-0 bg-white border-l-4 border-black p-6 overflow-y-auto ${className}`}>
            ...
            <div className="mb-8">
                <div className="mb-6">
                    ...
                    <p className="text-black font-bold text-sm mt-3">Follow the most popular creators</p>
                </div>
                            ...
                            <div className="flex items-start justify-between mb-3">
                                <div className="flex items-start space-x-3">
                                    ...
                                    <div className="flex-1 min-w-0">
                                        ...
                                        <div className="text-xs font-bold text-gray-600 mb-1">@{creator.username}</div>

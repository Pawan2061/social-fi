    ...
    async function handleSubmit() {
        try {
            ...
            if (type === "GOAL") {
                ...
                payload.targetValue = null; // per requirement, not taken for GOAL here
            } else {
                ...
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex gap-2">
                        <Button
                            ...
                            className={`px-4 py-2 font-extrabold border-4 border-black shadow-[4px_4px_0_0_#000] hover:shadow-[6px_6px_0_0_#000] transform hover:-translate-x-1 hover:-translate-y-1 ${type === "GOAL" ? "bg-pink-300 text-black" : "bg-white text-black"
                                }`}
                        >
                        ...
                        <Button
                            ...
                            className={`px-4 py-2 font-extrabold border-4 border-black shadow-[4px_4px_0_0_#000] hover:shadow-[6px_6px_0_0_#000] transform hover:-translate-x-1 hover:-translate-y-1 ${type === "POLL" ? "bg-yellow-300 text-black" : "bg-white text-black"
                                }`}
                        >
                                ...
                                <div className="flex flex-col gap-2">
                                    {options.map((o, idx) => (
                                        <div key={o.id} className="flex items-center gap-2">
                                            <Input
                                                ref={idx === options.length - 1 ? optionInputRef : undefined}
                                            ...
                                            <Button
                                                ...
                                                title={options.length <= 2 ? "At least two options required" : "Remove option"}
                                            >

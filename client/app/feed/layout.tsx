...
export default function FeedLayout({
    ...
    // Sample creators data - this could come from props or API in the future
    const popularCreators = [
        {
            ...
            verified: true,
            subscribers: 125000,
            description: "Blockchain developer & educator sharing Web3 insights daily 🚀",
            category: "Tech"
        },
        {
            id: "2",
        ...
        },
        {
            ...
            verified: true,
            subscribers: 156000,
            description: "Core Solana developer. Rust tutorials and ecosystem updates 🦀",
    ...
    return (
        <div className="min-h-screen bg-white relative">
            ...
            <div className="flex relative z-10">
                ...
                <div className="flex-1 min-h-screen flex">
                    ...
                    <div className="flex-1">
                        <div className="lg:hidden">
                            ...
                            <div className="sticky top-0 z-50 bg-white border-b-4 border-black p-4">
                ...
                <div className="lg:hidden fixed bottom-0 left-0 right-0 bg-white border-t-4 border-black p-4 z-50">
                    <div className="flex justify-around items-center">
                        {[
                            ...
                            { icon: 'M15 17h5l-5 5v-5zM10.5 9A1.5 1.5 0 109 7.5v5a1.5 1.5 0 001.5 1.5h5a1.5 1.5 0 001.5-1.5v-5A1.5 1.5 0 0015.5 6h-5z', label: 'Create' },
